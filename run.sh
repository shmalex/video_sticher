...
snap run ffmpeg -y -vsync 0 -hwaccel cuda -hwaccel_output_format cuda -r 60 -y -f image2 -i $renamed_dir/%7d.jpg  -tune hq -b:v 20M -bufsize 20M -maxrate 20M -c:v h264_nvenc -crf 30 $base_dir/video_fps120.mp4
